<%-- 
    Document   : UserCart
    Created on : Jul 11, 2023, 5:20:27 PM
    Author     : VHC
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/View/assets/CSS/UserCartStyle.css"/>
    </head>
    <body>
        ...
        <div class="Payment pos-fixed" style="display: none;">
            <div class="Payment_window m-t-50 m-l-auto m-r-auto">
                <form action="${pageContext.request.contextPath}/buy" method="get" onsubmit="return FormCheck()">
                    ...
                    <div class="CustomerInfo p-t-30 p-l-10 p-b-30">
                        ...
                        <label class="CustomerAddress w-100 justify-content-between">
                    ...
                    <div class="OrderResult dis-flex w-100 justify-content-between">
                        <div style="cursor: pointer" class="btn Cancel h-100 w-45" onclick="document.querySelector('.Payment').style.display = 'none';">Cancel</div>
                        <button style="cursor: pointer" class="Purchase h-100 w-45">Purchase</button>
                    </div>
                </form>
            </div>
            ...
            <div class="Product-content m-r-auto m-l-auto m-t-30 p-b-20 m-b-30">
                <div class="CartSumary dis-flex w-100 justify-content-between">
                    <div class="totalMoney font-weight-bold text-dark">
                        Total Price:
                        <span class="text-danger">${Cart.getTotalPriceString()}</span>
                </div>
                <div class="Buy_btn" onclick="document.querySelector('.Payment').style.display = 'block';">
                    Purchase
                </div>
            </div>
                        ...
                        <div class="item">
                            ...
                            <div class="item_detail text-left m-l-15">
                                ...
                                <div class="dis-flex align-items-center">
                                    <button class="Quantity_button" onclick="window.location.href = '${pageContext.request.contextPath}/updatecart?ProId=${p.getProId()}&Quantity=-1'">
                                    ...
                                    <input class="Quantity_input" name="Quantity" type="number" value="${p.getQuantity()}" min="1" max="${p.getProduct().getPro_Quantity()}" readonly="">
                                    <button class="Quantity_button ${p.getProduct().getPro_Quantity()==p.getQuantity()?'display-none':''}" onclick="window.location.href = '${pageContext.request.contextPath}/updatecart?ProId=${p.getProId()}&Quantity=1'">
                                ...
                                <div class="m-t-10" style="font-size: 12px">
                                    <i class="fa fa-user-circle"></i>
                                    ${p.getProduct().getDateDiff()}
                                </div>
                            </div>
                        </div>
                    </c:forEach>
