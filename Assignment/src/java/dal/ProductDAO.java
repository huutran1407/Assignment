...
public class ProductDAO  {
    ...
    public ArrayList<Products> getStudents() {
        ArrayList<Products> students = new ArrayList<>();
        try {
            ...
            while(rs.next())
            {
                ...
                s.setPro_Type(rs.getInt("Pro_Type"));
    ...
    public Products getProducts(int id) throws Exception {
        try {
            ...
            if (rs.next()) {
                Products s = new Products();
                s.setProId(rs.getString("Pro_Id"));
                s.setPro_Name(rs.getNString("Pro_Name"));
                s.setPro_Price(rs.getDouble("Pro_Price"));
                s.setPro_Quantity(rs.getInt("Pro_Quantity"));
                s.setPro_Seller(rs.getString("Pro_Seller"));
                s.setPro_Type(rs.getInt("Pro_Type"));
                s.setPro_des(rs.getString("Pro_description"));
    ...
    public void insertProduct(String pName, int pQuantity, int pType, String pSeller, String pImg, String pDescription, double pPrice,String pId ) throws Exception {
        try {
